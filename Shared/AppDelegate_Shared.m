...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MathTutor" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MathTutor.sqlite"];
...
- (IBAction) startCalled
{
	...
	if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
	{
		...
		[self.startController presentModalViewController:self.startController animated:YES];
		
		[self.window addSubview: self.startController.view];
	...
	else
	{
		...
		if ( self.navigationController == nil )
			self.navigationController = [[UINavigationController alloc] initWithRootViewController:self.startController];
